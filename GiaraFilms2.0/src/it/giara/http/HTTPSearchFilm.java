...
public class HTTPSearchFilm
{
    ...
    throws IOException, JSONException
  {
    ...
    while ((line = rd.readLine()) != null)
    {
      ...
      if ((find == -1) || (l != find + 17))
        continue;
      this.scheda.regia = StringEscapeUtils.unescapeHtml4(line.trim().replace("<li><span>REGIA</span>:", "").replace("</li>", "").trim());
      Log.log(Log.FILMINFO, this.scheda.regia);
    }
