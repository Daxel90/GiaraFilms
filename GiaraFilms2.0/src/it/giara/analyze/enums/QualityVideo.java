...
{
	NULL("Sconosciuta", 0, "null"), CAM("Registrato al cinema", 5, "CAM"),HDCAM("Registrato al cinema", 5, "HDCAM"), TS("Registrato al cinema", 5.5f, "TS"),
	TELESYNC("Registrato al cinema", 5.5f, "TELESYNC"),HDTS("Registrato al cinema", 5.5f, "HDTS"), SCREENER("Guardabile", 6, "SCREENER"),
	TC("Guardabile", 6, "TC"), R5("Decente", 7, "R5"), DVDSCR("Decente", 7, "DVDSCR"), DVDRip("Buono", 8, "DVDRip"),
	BDRip("Ottimo", 9, "BDRip"), BRRip("Ottimo", 9, "BRRip"),HDRip("Ottimo", 9, "HDRip"),  DVDMux("DVDMux", 8, "DVDMux"), PDTV("Buono", 8, "PDTV"),
