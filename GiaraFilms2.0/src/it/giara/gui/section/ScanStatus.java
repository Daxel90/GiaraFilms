...
public class ScanStatus extends DefaultGui
{
	...
	public void loadComponent()
	{
		...
		//
		// stat = new JLabel();
		// stat.setBounds(FRAME_WIDTH / 6, FRAME_HEIGHT * 3 / 4 - 35,
		// FRAME_WIDTH * 2 / 3, 80);
		// stat.setText("<html><h3>Film: " + ScanService.Nfilm + "<br>Episodi
		// SerieTV: " + ScanService.NEpisode
		// + "<br>File Totali: " + ScanService.Nfile + "</html>");
		// this.add(stat);
		//
		// list = new JLabel();
		// list.setBounds(FRAME_WIDTH / 6, (int) (FRAME_HEIGHT * 1.5f / 4 - 35),
		// FRAME_WIDTH * 2 / 3, 30);
		// list.setText(
		// "<html><h3>Controllate " + ScanService.NList + " liste su " +
		// ListLoader.sources.size() + "</html>");
		...
		// listBar.setBounds(FRAME_WIDTH / 6, (int) (FRAME_HEIGHT * 1.5f / 4),
		// FRAME_WIDTH * 2 / 3, 20);
		// this.add(listBar);
		//
		// file = new JLabel();
		// file.setBounds(FRAME_WIDTH / 6, (int) (FRAME_HEIGHT * 2.5f / 4 - 35),
		// FRAME_WIDTH * 2 / 3, 30);
		...
		// fileBar.setBounds(FRAME_WIDTH / 6, (int) (FRAME_HEIGHT * 2.5f / 4),
		// FRAME_WIDTH * 2 / 3, 20);
		//
		// this.add(fileBar);
		//
		...
		// timer.start();
		// ImageButton backbt = new
		// ImageButton(ImageUtils.getImage("gui/icon32px/arrow_left.png"),
		...
		// this.add(backbt);
		//
		// ImageButton homePage = new
		// ImageButton(ImageUtils.getImage("gui/icon32px/home.png"),
		// ImageUtils.getImage("gui/icon32px/home_over.png"),
		// ImageUtils.getImage("gui/icon32px/home_over.png"), OpenHomePage);
	...
	ActionListener UpdateStatus = new ActionListener()
	{
		...
		{
			// list.setText("<html><h3>Controllate " + ScanService.NList + "
			// liste su " + ListLoader.sources.size()
			// + "</html>");
			// listBar.setMaximum(ListLoader.sources.size());
			// listBar.setValue(ScanService.NList);
			// stat.setText("<html><h3>Film: " + ScanService.Nfilm +
			// "<br>Episodi SerieTV: " + ScanService.NEpisode
			// + "<br>File Totali: " + ScanService.Nfile + "</html>");
			// if (ScanService.HaveList)
			// {
			// file.setText("<html><h3>Analizzati " + ScanService.LStatus + "
			// file di " + ScanService.LSize
