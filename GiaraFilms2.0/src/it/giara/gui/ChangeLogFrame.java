...
public class ChangeLogFrame extends JFrame
{
	...
	public ChangeLogFrame()
	{
		...
		text.setText("<html>"
				...
				+ "<h2>Dev PreRelese 22" + "<br><h3>\t- Risolti Bug minori riguardanti lo ScanService"
				...
				+ "<h2>Dev PreRelese 20" + "<br><h3>\t- Effettuato Fix per i download contemporanei"
				...
				+ "<h2>Dev PreRelese 17" + "<br><h3>\t- Piccoli Fix di rilascio aggiornamento"
				+ "<h2>--------------------" + "<h2>Dev PreRelese 16 BIG UPDATE" + "<br><h3>\t- Aggiunta HomePage"
				...
				+ "<h2>--------------------" + "<h2>Dev PreRelese 15" + "<br><h3>\t- Migliorato algoritmo analisi file"
				...
				+ "<h2>Dev PreRelese 14" + "<br><h3>\t- Fix Caricamento Liste (CloudFlare fa schifo)"
				...
				+ "<h2>Dev PreRelese 12" + "<br><h3>\t- Vari Fix nei download"
				+ "<br><h3>\t- Auto riconnessione per file in attesa"
				+ "<br><h3>\t- Migliorato algoritmo di connessione" + "<h2>--------------------"
				+ "<h2>Dev PreRelese 11" + "<br><h3>\t- Settato descrizioine di FallBack in Inglese"
				+ "<br><h3>\t- Fix visualizzazione Generi" + "<h2>--------------------"
				+ "<h2>Dev PreRelese 10 BIG UPDATE" + "<br><h3>\t- Cambiato motore di ricerca Film!!"
				...
				+ "<h2>Dev PreRelese 9" + "<br><h3>\t- Fix per Aggiornamento sito Cooming Soon"
				+ "<h2>--------------------" + "<h2>Dev PreRelese 8"
				+ "<br><h3>\t- Fix Importante Salvataggio file in directory con spazi" + "<h2>--------------------"
				+ "<h2>Dev PreRelese 7" + "<br><h3>\t- Fix del Fix Pausa Download (Dev6)"
				...
				+ "<h2>Dev PreRelese 6" + "<br><h3>\t- Aggiunta dimensione dei file nelle liste"
				...
				+ "<h2>Dev PreRelese 4" + "<br><h3>\t- Sistemato errore di rendering nella sezione Download"
